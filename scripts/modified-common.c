...
{
    STATUS retStatus = STATUS_SUCCESS;
    PCHAR pCredentialsEndpoint, pRoleAlias, pSessionToken;
    ...
    CHK_ERR((pCredentialsEndpoint = getenv("IOT_GET_CREDENTIAL_ENDPOINT")) != NULL, STATUS_INVALID_OPERATION, "IOT_GET_CREDENTIAL_ENDPOINT must be set");
    CHK_ERR((pRoleAlias = getenv("ROLE_ALIAS")) != NULL, STATUS_INVALID_OPERATION, "ROLE_ALIAS must be set");
